...
STRATEGY_ORIGIN = PATH_GEANT + "split_ratio/Origin/"
STRATEGY_LSTM = PATH_GEANT + "split_ratio/LSTM/"
STRATEGY_CNN_LSTM = PATH_GEANT + "split_ratio/CNN_LSTM/"
STRATEGY_LSTM_OD = PATH_GEANT + "split_ratio/LSTM_OD_pair/"
STRATEGY_TCN = PATH_GEANT + "split_ratio/TCN/"
STRATEGY_LSTM_KEY_correct = PATH_GEANT + "split_ratio/LSTM_KEY_CORRECT/"
STRATEGY_DBN = PATH_GEANT + "split_ratio/DBN/"
STRATEGY_GRU = PATH_GEANT + "split_ratio/GRU/"
STRATEGY_GRU_OD = PATH_GEANT + "split_ratio/GRU_OD_pair/"
STRATEGY_GRU_KEY_CORRECT = PATH_GEANT + "split_ratio/GRU_KEY_CORRECT/"

Origin_TM = PATH_GEANT + "Origin/"

STRATEGY_LSTM_EKM_OD = PATH_GEANT + "split_ratio/LSTM-EKM_OD_pair/"
STRATEGY_LSTM_EKM_KEC_25 = PATH_GEANT + "split_ratio/LSTM_EKM_KEC_25/"
STRATEGY_LSTM_EKM_KEC_53 = PATH_GEANT + "split_ratio/LSTM_EKM_KEC_53/"
STRATEGY_LSTM_EKM_KEC_106 = PATH_GEANT + "split_ratio/LSTM_EKM_KEC_106/"
STRATEGY_LSTM_EKM_KEC_159 = PATH_GEANT + "split_ratio/LSTM_EKM_KEC_159/"
STRATEGY_LSTM_KEC_25 = PATH_GEANT + "split_ratio/LSTM_KEC_25/"
STRATEGY_LSTM_KEC_53 = PATH_GEANT + "split_ratio/LSTM_KEC_53/"
STRATEGY_LSTM_KEC_106 = PATH_GEANT + "split_ratio/LSTM_KEC_106/"
STRATEGY_LSTM_KEC_159 = PATH_GEANT + "split_ratio/LSTM_KEC_159/"

STRATEGY_GRU_EKM_OD = PATH_GEANT + "split_ratio/GRU-EKM_OD_pair/"
STRATEGY_GRU_EKM_KEC_25 = PATH_GEANT + "split_ratio/GRU_EKM_KEC_25/"
STRATEGY_GRU_EKM_KEC_53 = PATH_GEANT + "split_ratio/GRU_EKM_KEC_53/"
STRATEGY_GRU_EKM_KEC_106 = PATH_GEANT + "split_ratio/GRU_EKM_KEC_106/"
STRATEGY_GRU_EKM_KEC_159 = PATH_GEANT + "split_ratio/GRU_EKM_KEC_159/"
        ...
        while True:
            ...
            if not line == ' ':
                ...
                if not temp in OD_list:
                    continue
                data = str(src) + ' ' + str(dst) + ' ' + str(value) + '\n'
                f.write(data)
...
def draw_cdf(file_name):
    ...
    plt.legend(labels, loc='lower right')
    plt.savefig("MCF_MLU_result.png")
    plt.show()


def draw_MAE_RMSE(file_name):
    ...
    fig.tight_layout()
    plt.savefig("MCF_MLU_MAE_RMSE.png")
    plt.show()
...
if __name__ == "__main__":
    # generate MLU data
    topo_file = "geant.txt"
    out_file = "SDN_split_MLU_GEANT_EKM.csv"
    # strategy_path = [STRATEGY_ORIGIN, STRATEGY_LSTM, STRATEGY_CNN_LSTM, STRATEGY_LSTM_OD, STRATEGY_TCN,
    #                  STRATEGY_LSTM_KEY_correct, STRATEGY_DBN, STRATEGY_GRU, STRATEGY_GRU_OD, STRATEGY_GRU_KEY_CORRECT]
    ...
    # strategy_path = [STRATEGY_ORIGIN, STRATEGY_LSTM_EKM_OD, STRATEGY_LSTM_EKM_KEC_25, STRATEGY_LSTM_EKM_KEC_53,
    #                  STRATEGY_LSTM_EKM_KEC_106,
    #                  STRATEGY_LSTM_EKM_KEC_159, STRATEGY_LSTM_KEC_25, STRATEGY_LSTM_KEC_53, STRATEGY_LSTM_KEC_106,
    #                  STRATEGY_LSTM_KEC_159]

    # strategy_path = [STRATEGY_ORIGIN]

    # strategy_path = [STRATEGY_ORIGIN, STRATEGY_GRU_EKM_OD, STRATEGY_GRU_EKM_KEC_25, STRATEGY_GRU_EKM_KEC_53,
    #                  STRATEGY_GRU_EKM_KEC_106,
    #                  STRATEGY_GRU_EKM_KEC_159]

    strategy_path = [STRATEGY_ORIGIN, STRATEGY_LSTM_OD]
    ...
    for i in range(nums):
        ...
        count = 0
        for path in strategy_path:
            G = construct_graph("geant.txt")
            strategy_file = path + path.split("/")[-2] + '_' + str(i + 1) + ".txt"
            strategy_tm_file = PATH_GEANT + path.split("/")[-2] + "/" + path.split("/")[-2] + "_" \
    ...
    out_file = "SDN_split_MLU_bias_GEANT_EKM.csv"
    first_line = ["Data"]
    for path in strategy_path:
        first_line.append(path.split("/")[-2])
    write_row_to_csv(first_line, out_file)
    ...
    # draw cdf
    # draw_cdf("SDN_split_MLU_geant.csv")
    # draw_cdf_bias("SDN_split_MLU_bias_geant.csv")
    # draw_MAE_RMSE("SDN_split_MLU_MAE_RMSE.csv")

    # analyze overflow case
    # analysis_overflow("overflow_SDN_split_MLU_GEANT.csv", 90, 658)
