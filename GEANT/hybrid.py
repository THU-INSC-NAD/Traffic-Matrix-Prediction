...
def analysis_overflow(file_name, threshold, nums):
    ...
    plt.savefig('overflow_volume_hybrid.png', bbox_inches='tight')
    plt.show()
    plt.close()
    ...
    plt.xlabel('TM number')
    plt.ylabel('bias')
    plt.savefig('overflow_bias_hybrid.png', bbox_inches='tight')
    plt.show()
    plt.close()
    '''
    ...
    plt.xlabel('TM number')
    plt.ylabel('Volume')
    plt.savefig('overflow_total_TM_volume_hybrid.png', bbox_inches='tight')
    plt.show()
    '''
...
def generate_bias_and_MAE(file_name):
    ...
    out_file = "hybrid_MLU_bias_GEANT.csv"
...
if __name__ == "__main__":
    generate_bias_and_MAE("hybrid_MLU_GEANT.csv")


    # draw cdf
    # draw_cdf("hybrid_MLU_GEANT.csv", "hybrid_MLU_result.png")
    # draw_cdf_bias("hybrid_MLU_bias_GEANT.csv", "hybrid_MLU_bias.png")
    # draw_MAE_RMSE("hybrid_MLU_MAE_RMSE.csv", "hybrid_MLU_MAE_RMSE.png")

    # analyze overflow case
    # analysis_overflow("overflow_hybrid_GEANT.csv", 85, 658)
