...
class PridictTM():
    ...
    def save_TM(self, result_list):
        ...
        for i in range(test_data_length):
            ...
            file_name = "../TM_result/CERNET/GRU_OD_pair/\GRU_OD_pair_" + str(i + 1) + ".txt"
    ...
    def train(self):
        ...
        # OD_list = ["OD_1-14"]
        model_path = "../CERNET/model_GRU_OD/"
        # model_path = "/home/liuzhifeng/workspace/code/traffic-matrix-prediction/model_GRU_OD_pair_CERNET/"
        result_list = []
        for i in range(196):
            result_list.append([])
