...
STRATEGY_ORIGIN = PATH_CERNET + "split_ratio/Origin/"
STRATEGY_LSTM = PATH_CERNET + "split_ratio/LSTM/"
STRATEGY_CNN_LSTM = PATH_CERNET + "split_ratio/CNN_LSTM/"
STRATEGY_LSTM_OD = PATH_CERNET + "split_ratio/LSTM_OD_pair/"
STRATEGY_TCN = PATH_CERNET + "split_ratio/TCN/"
STRATEGY_LSTM_KEY_correct = PATH_CERNET + "split_ratio/LSTM_KEY_CORRECT/"
STRATEGY_DBN = PATH_CERNET + "split_ratio/DBN/"
STRATEGY_GRU = PATH_CERNET + "split_ratio/GRU/"
STRATEGY_GRU_OD = PATH_CERNET + "split_ratio/GRU_OD_pair/"
STRATEGY_GRU_KEY_correct = PATH_CERNET + "split_ratio/GRU_KEY_CORRECT/"

STRATEGY_LSTM_EKM_OD = PATH_CERNET + "split_ratio/LSTM-EKM_OD_pair/"
STRATEGY_LSTM_EKM_KEC_10 = PATH_CERNET + "split_ratio/LSTM_EKM_KEC_10/"
STRATEGY_LSTM_EKM_KEC_20 = PATH_CERNET + "split_ratio/LSTM_EKM_KEC_20/"
STRATEGY_LSTM_EKM_KEC_40 = PATH_CERNET + "split_ratio/LSTM_EKM_KEC_40/"
STRATEGY_LSTM_EKM_KEC_78 = PATH_CERNET + "split_ratio/LSTM_EKM_KEC_78/"
STRATEGY_LSTM_KEC_10 = PATH_CERNET + "split_ratio/LSTM_KEC_10/"
STRATEGY_LSTM_KEC_20 = PATH_CERNET + "split_ratio/LSTM_KEC_20/"
STRATEGY_LSTM_KEC_40 = PATH_CERNET + "split_ratio/LSTM_KEC_40/"
STRATEGY_LSTM_KEC_78 = PATH_CERNET + "split_ratio/LSTM_KEC_78/"

STRATEGY_GRU_EKM_OD = PATH_CERNET + "split_ratio/GRU-EKM_OD_pair/"
STRATEGY_GRU_EKM_KEC_10 = PATH_CERNET + "split_ratio/GRU_EKM_KEC_10/"
STRATEGY_GRU_EKM_KEC_20 = PATH_CERNET + "split_ratio/GRU_EKM_KEC_20/"
STRATEGY_GRU_EKM_KEC_40 = PATH_CERNET + "split_ratio/GRU_EKM_KEC_40/"
STRATEGY_GRU_EKM_KEC_78 = PATH_CERNET + "split_ratio/GRU_EKM_KEC_78/"
...
def draw_cdf(file_name):
    color_dict = {"Origin":"red", "LSTM":"deepskyblue", "CNN_LSTM":"orange", "LSTM_OD_pair":"seagreen", "TCN":"slategray",
                  "LSTM_KEY_CORRECT":"purple", "DBN":"brown", "GRU":"blue", "GRU_OD_pair":"tomato", "GRU_KEY_CORRECT":"black"}
...
def draw_cdf_bias(file_name):
    color_dict = {"Origin":"red", "LSTM":"deepskyblue", "CNN_LSTM":"orange", "LSTM_OD_pair":"seagreen", "TCN":"slategray",
                  "LSTM_KEY_CORRECT":"purple", "DBN":"brown", "GRU":"blue", "GRU_OD_pair":"tomato", "GRU_KEY_CORRECT":"red"}
    df = pd.read_csv(file_name)
    plt.xlim((0, 0.8))
    ...
    with open(file_name) as csvfile:
        ...
        for row in readCSV:
            ...
            for i in range(1, len(row)):
                volume += float(row[i])
            data = [row[0], volume]
            write_row_to_csv(data, "temp.csv")


if __name__ == "__main__":
    topo_file = "cernet.txt"
    out_file = "SDN_split_MLU_CERNET_EKM.csv"
    ...
    # strategy_path = [STRATEGY_ORIGIN, STRATEGY_LSTM_EKM_OD, STRATEGY_LSTM_EKM_KEC_10, STRATEGY_LSTM_EKM_KEC_20,
    #                  STRATEGY_LSTM_EKM_KEC_40,
    #                  STRATEGY_LSTM_EKM_KEC_78, STRATEGY_LSTM_KEC_10, STRATEGY_LSTM_KEC_20, STRATEGY_LSTM_KEC_40,
    #                  STRATEGY_LSTM_KEC_78]

    # strategy_path = [STRATEGY_ORIGIN]

    # strategy_path = [STRATEGY_ORIGIN, STRATEGY_GRU_EKM_OD, STRATEGY_GRU_EKM_KEC_10, STRATEGY_GRU_EKM_KEC_20,
    #                  STRATEGY_GRU_EKM_KEC_40, STRATEGY_GRU_EKM_KEC_78]
    ...
    for i in range(nums):
        ...
        count = 0
        for path in strategy_path:
            G = construct_graph("CERNET.txt")
            strategy_file = path + path.split("/")[-2] + '_' + str(i + 1) + ".txt"
            strategy_tm_file = PATH_CERNET + path.split("/")[-2] + "/" + path.split("/")[-2] + "_" \
    ...
    out_file = "SDN_split_MLU_bias_CERNET_EKM.csv"
    first_line = ["Data"]
    for path in strategy_path:
        first_line.append(path.split("/")[-2])
    write_row_to_csv(first_line, out_file)
    ...
    # draw result
    # draw_cdf("SDN_split_MLU_CERNET.csv")
    # draw_cdf_bias("SDN_split_MLU_bias_CERNET.csv")
    # draw_MAE_RMSE("SDN_split_MLU_MAE_RMSE.csv")


    # analysis_overflow("overflow_SDN_split_MLU_CERNET.CSV", 95, 1238)
