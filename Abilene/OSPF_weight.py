...
PATH_OSPF_Abilene = "C:/Microsoft Visual Studio 11.0/workspace/OSPF/SOTE/Abilene/"
PATH_HYBRID_Abilene = "E:/java_workspace/SOTE/TM_predict/Abilene/"

Origin_TM = PATH_Abilene + "Origin/"
LSTM_TM = PATH_Abilene + "LSTM/"
CNN_LSTM_TM = PATH_Abilene + "CNN_LSTM/"
TCN_TM = PATH_Abilene + "TCN/"
LSTM_KEY_CORRECT_TM = PATH_Abilene + "LSTM_KEY_CORRECT/"
LSTM_OD_pair_TM = PATH_Abilene + "LSTM_OD_pair/"
DBN_TM = PATH_Abilene + "DBN/"
GRU_TM = PATH_Abilene + "GRU/"
GRU_OD_pair_TM = PATH_Abilene + "GRU_OD_pair/"
GRU_KEY_CORRECT_TM = PATH_Abilene + "GRU_KEY_CORRECT/"

LSTM_EKM_OD_TM = PATH_Abilene + "LSTM-EKM_OD_pair/"
LSTM_EKM_KEC_7_TM = PATH_Abilene + "LSTM_EKM_KEC_7/"
LSTM_EKM_KEC_14_TM = PATH_Abilene + "LSTM_EKM_KEC_14/"
LSTM_EKM_KEC_28_TM = PATH_Abilene + "LSTM_EKM_KEC_28/"
LSTM_EKM_KEC_43_TM = PATH_Abilene + "LSTM_EKM_KEC_43/"
LSTM_KEC_7_TM = PATH_Abilene + "LSTM_KEC_7/"
LSTM_KEC_14_TM = PATH_Abilene + "LSTM_KEC_14/"
LSTM_KEC_28_TM = PATH_Abilene + "LSTM_KEC_28/"
LSTM_KEC_43_TM = PATH_Abilene + "LSTM_KEC_43/"
GRU_EKM_OD_TM = PATH_Abilene + "GRU-EKM_OD_pair/"
GRU_EKM_KEC_7_TM = PATH_Abilene + "GRU_EKM_KEC_7/"
GRU_EKM_KEC_14_TM = PATH_Abilene + "GRU_EKM_KEC_14/"
GRU_EKM_KEC_28_TM = PATH_Abilene + "GRU_EKM_KEC_28/"
GRU_EKM_KEC_43_TM = PATH_Abilene + "GRU_EKM_KEC_43/"


Origin_OSPF_TM = PATH_OSPF_Abilene + "Origin/"
LSTM_OSPF_TM = PATH_OSPF_Abilene + "LSTM/"
CNN_LSTM_OSPF_TM = PATH_OSPF_Abilene + "CNN_LSTM/"
TCN_OSPF_TM = PATH_OSPF_Abilene + "TCN/"
LSTM_KEY_CORRECT_OSPF_TM = PATH_OSPF_Abilene + "LSTM_KEY_CORRECT/"
LSTM_OD_pair_OSPF_TM = PATH_OSPF_Abilene + "LSTM_OD_pair/"
DBN_OSPF_TM = PATH_OSPF_Abilene + "DBN/"
GRU_OSPF_TM = PATH_OSPF_Abilene + "GRU/"
GRU_OD_pair_OSPF_TM = PATH_OSPF_Abilene + "GRU_OD_pair/"
GRU_KEY_CORRECT_OSPF_TM = PATH_OSPF_Abilene + "GRU_KEY_CORRECT/"

LSTM_EKM_OD_OSPF_TM = PATH_OSPF_Abilene + "LSTM-EKM_OD_pair/"
LSTM_EKM_KEC_7_OSPF_TM = PATH_OSPF_Abilene + "LSTM_EKM_KEC_7/"
LSTM_EKM_KEC_14_OSPF_TM = PATH_OSPF_Abilene + "LSTM_EKM_KEC_14/"
LSTM_EKM_KEC_28_OSPF_TM = PATH_OSPF_Abilene + "LSTM_EKM_KEC_28/"
LSTM_EKM_KEC_43_OSPF_TM = PATH_OSPF_Abilene + "LSTM_EKM_KEC_43/"
LSTM_KEC_7_OSPF_TM = PATH_OSPF_Abilene + "LSTM_KEC_7/"
LSTM_KEC_14_OSPF_TM = PATH_OSPF_Abilene + "LSTM_KEC_14/"
LSTM_KEC_28_OSPF_TM = PATH_OSPF_Abilene + "LSTM_KEC_28/"
LSTM_KEC_43_OSPF_TM = PATH_OSPF_Abilene + "LSTM_KEC_43/"
GRU_EKM_OD_OSPF_TM = PATH_OSPF_Abilene + "GRU-EKM_OD_pair/"
GRU_EKM_KEC_7_OSPF_TM = PATH_OSPF_Abilene + "GRU_EKM_KEC_7/"
GRU_EKM_KEC_14_OSPF_TM = PATH_OSPF_Abilene + "GRU_EKM_KEC_14/"
GRU_EKM_KEC_28_OSPF_TM = PATH_OSPF_Abilene + "GRU_EKM_KEC_28/"
GRU_EKM_KEC_43_OSPF_TM = PATH_OSPF_Abilene + "GRU_EKM_KEC_43/"


Origin_HYBRID_TM = PATH_HYBRID_Abilene + "Origin/"
LSTM_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM/"
CNN_LSTM_HYBRID_TM = PATH_HYBRID_Abilene + "CNN_LSTM/"
TCN_HYBRID_TM = PATH_HYBRID_Abilene + "TCN/"
LSTM_KEY_CORRECT_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_KEY_CORRECT/"
LSTM_OD_pair_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_OD_pair/"
DBN_HYBRID_TM = PATH_HYBRID_Abilene + "DBN/"
GRU_HYBRID_TM = PATH_HYBRID_Abilene + "GRU/"
GRU_OD_pair_HYBRID_TM = PATH_HYBRID_Abilene + "GRU_OD_pair/"
GRU_KEY_CORRECT_HYBRID_TM = PATH_HYBRID_Abilene + "GRU_KEY_CORRECT/"

LSTM_EKM_OD_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM-EKM_OD_pair/"
LSTM_EKM_KEC_7_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_EKM_KEC_7/"
LSTM_EKM_KEC_14_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_EKM_KEC_14/"
LSTM_EKM_KEC_28_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_EKM_KEC_28/"
LSTM_EKM_KEC_43_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_EKM_KEC_43/"
LSTM_KEC_7_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_KEC_7/"
LSTM_KEC_14_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_KEC_14/"
LSTM_KEC_28_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_KEC_28/"
LSTM_KEC_43_HYBRID_TM = PATH_HYBRID_Abilene + "LSTM_KEC_43/"
GRU_EKM_OD_HYBRID_TM = PATH_HYBRID_Abilene + "GRU-EKM_OD_pair/"
GRU_EKM_KEC_7_HYBRID_TM = PATH_HYBRID_Abilene + "GRU_EKM_KEC_7/"
GRU_EKM_KEC_14_HYBRID_TM = PATH_HYBRID_Abilene + "GRU_EKM_KEC_14/"
GRU_EKM_KEC_28_HYBRID_TM = PATH_HYBRID_Abilene + "GRU_EKM_KEC_28/"
GRU_EKM_KEC_43_HYBRID_TM = PATH_HYBRID_Abilene + "GRU_EKM_KEC_43/"
    ...
    with open(topo_file, 'r') as readTxt:
        while True:
            ...
            if line.count(' ') == 1:  # node number and edge number
                ...
                node_num = int(line[0])
                edge_num = int(line[1])
                f.write("NUM-NODES: " + str(node_num) + '/n')
                ...
                capa = int(line[2])
                weight = int(line[3])
                f.write("LINK: " + str(src) + ' ' + str(dst) + ' ' + "CC 1/n")
...
def generate_bias_and_MAE(file_name):
    ...
    out_file = "OSPF_MLU_bias_Abilene.csv"
...
if __name__ == "__main__":
    ...
    # generate_topo("Abilene.txt", "ospf_Abilene.txt")
    # generate_topo("abilene.txt", "abilene.topo")
    ...
    # in_path_list = [LSTM_EKM_OD_TM, LSTM_EKM_KEC_7_TM, LSTM_EKM_KEC_14_TM, LSTM_EKM_KEC_28_TM, LSTM_EKM_KEC_43_TM,
    #                 LSTM_KEC_7_TM, LSTM_KEC_14_TM, LSTM_KEC_28_TM, LSTM_KEC_43_TM]

    #
    # out_path_list = [LSTM_EKM_OD_OSPF_TM, LSTM_EKM_KEC_7_OSPF_TM, LSTM_EKM_KEC_14_OSPF_TM, LSTM_EKM_KEC_28_OSPF_TM, LSTM_EKM_KEC_43_OSPF_TM,
    #                 LSTM_KEC_7_OSPF_TM, LSTM_KEC_14_OSPF_TM, LSTM_KEC_28_OSPF_TM, LSTM_KEC_43_OSPF_TM]

    # out_path_list = [LSTM_EKM_OD_HYBRID_TM, LSTM_EKM_KEC_7_HYBRID_TM, LSTM_EKM_KEC_14_HYBRID_TM, LSTM_EKM_KEC_28_HYBRID_TM, LSTM_EKM_KEC_43_HYBRID_TM,
    #                 LSTM_KEC_7_HYBRID_TM, LSTM_KEC_14_HYBRID_TM, LSTM_KEC_28_HYBRID_TM, LSTM_KEC_43_HYBRID_TM]


    # in_path_list = [GRU_EKM_OD_TM, GRU_EKM_KEC_7_TM, GRU_EKM_KEC_14_TM, GRU_EKM_KEC_28_TM, GRU_EKM_KEC_43_TM]
    #
    #
    # out_path_list = [GRU_EKM_OD_OSPF_TM, GRU_EKM_KEC_7_OSPF_TM, GRU_EKM_KEC_14_OSPF_TM,
    #                  GRU_EKM_KEC_28_OSPF_TM, GRU_EKM_KEC_43_OSPF_TM]
    #
    # # out_path_list = [GRU_EKM_OD_HYBRID_TM, GRU_EKM_KEC_7_HYBRID_TM, GRU_EKM_KEC_14_HYBRID_TM,
    # #                  GRU_EKM_KEC_28_HYBRID_TM, GRU_EKM_KEC_43_HYBRID_TM]
    #
    # for i in range(len(in_path_list)):
    #     generate_TMs(in_path_list[i], out_path_list[i], 12)


    # get bias and MAE of MLU' and MLU
    generate_bias_and_MAE("OSPF_MLU_Abilene.csv")

    # draw results
    # draw_cdf("OSPF_MLU_Abilene.csv", "OSPF_MLU_result.png")
    # draw_cdf_bias("OSPF_MLU_bias_Abilene.csv", "OSPF_MLU_bias.png")
    # draw_MAE_RMSE("OSPF_MLU_MAE_RMSE.csv", "OSPF_MLU_MAE_RMSE.png")

    # overflow analysis
    # analysis_overflow("overflow_OSPF_Abilene.csv", 90, 1276)